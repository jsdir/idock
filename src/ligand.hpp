...
public:
	...
	int bfgs(float* s0e, float* h, const scoring_function& sf, const receptor& rec, const size_t seed, const size_t num_generations, const unsigned int threadIdx, const unsigned int blockDim) const;
