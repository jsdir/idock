...
NVCC=nvcc -gencode arch=compute_11,code=sm_11 -Xptxas=-v -ftz=true -prec-div=false -prec-sqrt=false -use_fast_math# -maxrregcount=N -g -G -Xcompiler -rdynamic -lineinfo
